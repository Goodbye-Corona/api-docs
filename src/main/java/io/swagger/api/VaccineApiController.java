...
@RestController
public class VaccineApiController implements VaccineApi {

    private static final Logger log = LoggerFactory.getLogger(VaccineApiController.class);
    ...
    public VaccineApiController(ObjectMapper objectMapper, HttpServletRequest request) {
