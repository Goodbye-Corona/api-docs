...
public interface VaccineApi {
    ...
    @Operation(summary = "searches inventory", description = "By passing in the appropriate options, you can search for available inventory in the system ", tags={ "COVID-19-INFECTION" })
    @ApiResponses(value = { 
